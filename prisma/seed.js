...
async function main() {
    ...
    await prisma.property.createMany({
        data: [
            ...
            {name: "Nørreport Station", houses: 0, price: 2500, rent: parseInt(2500 * 0.3), collection: "Transport"},
            ...
            {name: "Jespers Torvekøkken", houses: 0, price: 750, rent: parseInt(750 * 0.3), collection: "Universitet"},
            ...
            {name: "Ringkøbing", houses: 0, price: 500, rent: parseInt(500 * 0.3), collection: "Jylland"},
            ...
            {name: "Ørslev", houses: 0, price: 500, rent: parseInt(500 * 0.3), collection: "Sjælland"},
            ...
            {name: "Nørrebro", houses: 0, price: 600, rent: parseInt(600 * 0.3), collection: "København S"},
